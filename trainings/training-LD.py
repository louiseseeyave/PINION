...
# This script produces the training with the low data settings.
# This settings trains the network with two losses: the ODE constraint and the data loss.
# However, for the data loss, only a limited sample of snapshots are picked for the training.
# This possibly reduces the data bias.
...
UID = 'LD' + generate_random_string(6) # id to save stuff and avoid overriding plots.
